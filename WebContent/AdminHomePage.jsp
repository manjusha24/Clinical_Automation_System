		...
		<div>
			...
			<ul>
				...
				<li>
					...
					<div>
						<p>
							Fast and clear x-ray results. Youâ€™ll be assisted by our friendly staff all the way.
						</p>
						<a href="blog.html" class="more">read more</a>
					</div>
				...
				<li>
					...
					<div>
						<p>
							State of the art testing for DNA thatâ€™s sure to be have fast and accurate results.
						</p>
						<a href="blog.html" class="more">read more</a>
					</div>
